...
const routeConfig = [
  ...
  { path: '/user/resignation-exit', component: withProtected(ResignationExit, ['employee', 'user', 'admin', 'super_admin']), layout: BlankLayout },
  { path: '/user/resignation', component: withProtected(ResignationExit, ['employee', 'user', 'admin', 'super_admin']), layout: BlankLayout },
